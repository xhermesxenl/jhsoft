...
import fr.corp.start.IntegrationTest;
import fr.corp.start.config.Constants;
import fr.corp.start.domain.User;
import fr.corp.start.repository.AuthorityRepository;
...
import fr.corp.start.service.dto.PasswordChangeDTO;
import fr.corp.start.web.rest.vm.KeyAndPasswordVM;
import fr.corp.start.web.rest.vm.ManagedUserVM;
